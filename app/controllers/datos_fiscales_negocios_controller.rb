class DatosFiscalesNegociosController < ApplicationController
  ...
  private
    ...
    def datos_fiscales_negocio_params
      params.require(:datos_fiscales_negocio).permit(:nombreFiscal, :rfc, :regimen_fiscal, :calle, :numExterior, :numInterior, :colonia, :codigo_postal, :municipio, :delegacion, :estado, :email)
    end
